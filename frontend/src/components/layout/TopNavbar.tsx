...
export const TopNavbar: React.FC<TopNavbarProps> = ({ onOpenMobileMenu }) => {
  ...
  return (
    <header className="sticky top-0 z-20 flex h-16 sm:h-20 md:h-24 w-full items-center justify-between border-b border-border bg-card/95 px-3.5 sm:px-6 md:px-10 backdrop-blur-md">

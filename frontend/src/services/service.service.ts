...
import { ServicesResponse, SingleServiceResponse, ServiceItem, CreateServicePayload } from "../types/service";
...
export const serviceService = {
  ...
  async createService(payload: CreateServicePayload): Promise<SingleServiceResponse> {
    const data = await apiFetch<ServiceItem>("/services", {
      method: "POST",
